...
Class names, module names and directories follow the same **PascalCase** convention, take a look at the [Files structure](architecture/patterns/app-files-structure.md) section for more information.
