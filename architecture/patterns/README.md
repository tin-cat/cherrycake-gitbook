...
* The [Css](../../reference/core-modules/css/) and [JavaScript](../../reference/core-modules/javascript.md) modules work with Patterns too, bringing all this capabilities also to your Css and JavaScript files.
